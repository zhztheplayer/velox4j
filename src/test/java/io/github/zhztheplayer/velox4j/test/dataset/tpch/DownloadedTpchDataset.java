...
/**
 * A TPC-H Parquet SF0.1 dataset downloaded from GitHub repo optaxis/tpc-data. Note, this is a
 ...
 * <pre>
 * 1. cd /tmp
 * 2. wget https://github.com/optaxis/tpc-data/releases/download/v0.1.0/tpch-parquet-sf0.1.tar.gz
...
class DownloadedTpchDataset implements TpchDataset {
  private static final String DOWNLOAD_LINK =
      "https://github.com/optaxis/tpc-data/releases/download/v0.1.0/tpch-parquet-sf0.1.tar.gz";
